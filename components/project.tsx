    ...
    return ( 
        ...
        >
            <section 
                ...
                hover:bg-gray-200 transition sm:group-even:pl-6 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
                ...
                sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full sm:group-even:ml-[18rem]">
                    ...
                    text-gray-700 dark:text-white/70">{description}</p>
                ...
                <Image 
                    ...
                    group-even:en:group-hover:translate-x-3
