    ...
    <section
        ...
        <div className='flex items-center justify-center'>
            <div className="relative">
                ...
                >
                    <Image src="/portrait_me.png"
                    alt="Shreyas Portrait"
                    width="192"
                    height="192"
                    quality="95"
                    priority={true} 
        ...
        >
            ...
            developer</span> with{" "}
            <span className="font-bold">Experience as</span> a data analyst. I enjoy
            building <span className="italic">sites & apps</span>. My focus is{" "}
            <span className="underline">Data Analysis</span>.
        </motion.h1>
        ...
        >
            ...
            <a 
                ...
                href="https://linkedin.com/in/shreyaskarle" 
                target="_blank"
            >
                <BsLinkedin />
            </a>
            ...
            <a 
                ...
                transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
                href="https://github.com/shrek6201" 
                target="_blank"
            >
                <FaGithubSquare />
            </a>
